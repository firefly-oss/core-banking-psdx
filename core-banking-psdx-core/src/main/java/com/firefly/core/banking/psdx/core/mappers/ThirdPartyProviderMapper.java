...
public interface ThirdPartyProviderMapper {
    ...
    @Mapping(target = "providerType", expression = "java(com.firefly.core.banking.psdx.interfaces.enums.ProviderType.valueOf(registrationDTO.getProviderType()))")
    ...
    @Mapping(target = "providerType", expression = "java(com.firefly.core.banking.psdx.interfaces.enums.ProviderType.valueOf(providerDTO.getProviderType()))")
